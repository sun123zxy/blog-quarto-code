...
% workaround for spath3 incompatibility with latest l3kernel. See https://tex.stackexchange.com/questions/762952/l3kernel-latest-update-introduce-an-incompatibility-with-tikz-library-spath3
\ExplSyntaxOn
...
$if(header-includes)$
$header-includes/first$ % other header includes is injected by Quarto, hence ignored
$endif$

$if(sunquartex-logo)$
$sunquartex-logo$ % inject SunQuarTeX logo, metadata given by the Lua filter
$endif$
