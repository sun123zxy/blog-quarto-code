...
| $${1,1/\Sigma,1}$$ | Labeled | Labeled; $r$-disabled | NON empty | $$\sum_{k=0}^n k! {n \brace k}$$ | $$\mathrm{EGF}_r(x)=\frac{1}{2-e^x} = \frac{1}{1-(e^x-1)}$$ | ordered Bell number; number of week orderings / ordered set partitions on $[n]$ |
