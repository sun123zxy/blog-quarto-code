...
热身赛 D 供题人．原题出自 [2023 年 BIT 校赛 H](https://codeforces.com/gym/104825/problem/H)，非常荣幸被组题人收入热身赛供大家把玩．看到很多人对题目背后的动机感兴趣，也在这里写个题解，稍稍探讨一下此类行列式背后通用的计算技巧．
...
- AND Determinant / 高维前缀和 / 容斥原理：
  ...
  $$
  \det \begin{pmatrix} a_{i \& j} \end{pmatrix}_{2^n \times 2^n} = \prod_{1 \leq k \leq n} \sum_{t \subseteq k} (-1)^{\operatorname{popcount}(k)-\operatorname{popcount}(t)} a_t
  $$
  借助 FMT 可做到 $O(n 2^n)$．
