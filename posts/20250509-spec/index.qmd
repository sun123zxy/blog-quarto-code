...
Among them, prime ideals are exactly those products where prime ideals occurs once while all the other factors are entire rings. In Zariski-topological words, $\Spec \prod_{k=1}^n R_k \cong \bigsqcup_{k=1}^n \Spec R_k$.
:::
