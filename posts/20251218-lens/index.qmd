...
下面仅依赖 Fermat 原理和 Snell 定律解析薄透镜的成像原理．策略上，我们首先证明单面透镜单点成像清晰（所有从物点发出的光线均汇于一点），再通过过光心光线和平行光交叉得到成像位置，最后推广到双面薄透镜．
...
由于已经证明了成像的清晰性，我们可以通过两条光线的交点确定像点位置．过光心的光线入射出射时法向均与垂直于折射面，故沿直线传播．平行光入射时，经过透镜后聚于距透镜 $f$ 处．简单几何推演
