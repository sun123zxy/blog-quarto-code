...
反正他就是那种人了。不过不管怎么说，他自己还算满意现在的生活。说不定有人喜欢这种性格呢。

## Introduction (Aug. 2021)
...
整活方面的话，最近在~~填坑~~研究 Minecraft 中[基于 Python 和 MIDI 的自动化红石音乐生成](https://github.com/sun123zxy/redstone-music-generator)，当然还有正在搭的博客啦。~~一放假 github 就一堆小绿点（~~
