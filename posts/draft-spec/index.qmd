...
lang: en
abstract: "Thanks to the strong tools borrowed from commutative algebra, we show a general approach to determine the prime spectrum of a coordinate ring by examples. As we determine the spectrum of the Guassian integers, a proof of the famous two squares theorem emerges without tricky techniques."
