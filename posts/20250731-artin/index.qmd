...
subtitle: "On Proving the Akizuki--Hopkins--Levitzki Theorem"
author: "sun123zxy"
date: 2025/08/01
lang: zh
...
本文所指环均为交换幺环．我们重新编排一下 [@m_f_atiyah_introduction_1969, {chapter 8}] 的顺序，开发如下著名的 Artin 环等价刻画的证明：
...
## Extra：主理想局部 Noether 环的理想结构

当局部 Artin 环 $A$ 的极大理想 $\mathfrak m$ 是主理想时，$A$ 的理想结构将变得异常简单．以下结果甚至对 Noether 环也是成立的：
