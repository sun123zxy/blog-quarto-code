...
- [书内、站点绝对、index 链接](/)
- [书内、站点绝对、qmd 链接](/examples/enart.qmd#exm-rtimesn)
- [书内、站点绝对、html 链接](/examples/enart.html#exm-rtimesn)

需要链接在书内的文档：使用相对链接或者标签链接

- [书内、文档相对、qmd 链接](enart.qmd#exm-rtimesn)
- [书内、文档相对、html 链接](enart.html#exm-rtimesn)
- 标签链接 [@exm-rtimesn]

错误示范：对不在书内、在站点内的文档使用相对链接，渲染书籍时非 HTML 格式 Quarto 可能无法正确处理：

- [书外、文档相对、qmd 链接](helloworld.qmd)
- [书外、文档相对、html 链接](helloworld.html)
